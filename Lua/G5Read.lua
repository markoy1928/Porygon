...
while true do
	if emu.framecount() % 30 == 1 then
		...
		for i = 1, 6, 1 do
			print(string.format("PKM%d = %d, Gender = %d,  HP = %d, MAXHP = %d, Lvl = %d, Status = %d, Egg = %d", i, ID2[i], Gender2[i], HP2[i], MAXHP2[i], Lvl2[i], Status2[i], Egg2[i]))
			print(string.format("Move1 = %d %d/%d, Move2 = %d %d/%d, Move3 = %d %d/%d, Move4 = %d %d/%d", Move1_2[i], PP1_2[i], MAXPP1_2[i], Move2_2[i], PP2_2[i], MAXPP2_2[i], Move3_2[i], PP3_2[i], MAXPP3_2[i], Move4_2[i], PP4_2[i], MAXPP4_2[i]))
		end
